...
/**
 * installerProdDebugProjectContainer.
 *
...
class installerProdDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('rgVf3GiBt9', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('installer-59ddcce4a5ef64.11450573');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Uzgyv3yFi7', 0, 'QeTZ8YWvToZqa80QUYigYs', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.secret' => 'installer-59ddcce4a5ef64.11450573',
